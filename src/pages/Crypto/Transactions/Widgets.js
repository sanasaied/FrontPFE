                    ...
                    <CardBody>
                        <div className="d-flex mb-3">
                            ...
                            <div className="flex-shrink-0">
                                <Link to="#" className="badge badge-soft-secondary badge-border">BTC</Link>
                                <Link to="#" className="badge badge-soft-secondary badge-border">ETH</Link>
                                <Link to="#" className="badge badge-soft-secondary badge-border">USD</Link>
                                <Link to="#" className="badge badge-soft-secondary badge-border">EUR</Link>
                            </div>
                        </div>
                        <h3 className="mb-2">
            ...
            <Col xxl={3} md={6}>
                <Card className="card-animate">
                    <CardBody>
                        <div className="d-flex mb-3">
                            <div className="flex-grow-1">
                                <lord-icon src="https://cdn.lordicon.com/qhviklyi.json" trigger="loop" colors="primary:#405189,secondary:#00bd9d" style={{ width: "55px", height: "55px" }}></lord-icon>
                            </div>
                            <div className="flex-shrink-0">
                                <Link to="#" className="badge badge-soft-secondary badge-border">BTC</Link>
                                <Link to="#" className="badge badge-soft-secondary badge-border">ETH</Link>
