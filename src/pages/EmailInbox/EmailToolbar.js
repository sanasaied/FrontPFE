                ...
                <div className="p-4 pb-0">
                    <div className="border-bottom border-bottom-dashed">
                        ...
                        <Row className="align-items-center mt-3">
                            <Col>
                                <ul className="nav nav-tabs nav-tabs-custom nav-primary gap-1 text-center border-bottom-0" role="tablist">
                                    <NavItem>
                    ...
                    <OffcanvasBody className="overflow-hidden">
                        <div className="pb-4 border-bottom border-bottom-dashed">
                            <Row>
                                <Col>
                                    <div className="">
                                        <button type="button" className="btn btn-soft-primary btn-icon btn-sm fs-16 close-btn-email" onClick={toggleRightCanvas}>
