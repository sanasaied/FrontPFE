...
const PortfolioCharts = () => {
    const donutchartportfolioColors = ["#25a0e2", "rgba(37,160,226,0.85)", "rgba(37,160,226,0.65)", "rgba(37,160,226,0.50)"];
...
const MarkerCharts = () => {
    const MarketchartColors = ["rgba(0,189,157,0.75)", "rgba(240,101,72,0.75)"];
    const series = [{
        data: [{
